(function (e) {
            ...
            if (jQuery(window).width() >= 1200) {
                if (jQuery('.header_1 .main-header,.header_2 .main-header,.header_3 .main-header').hasClass("sticky_header")) {
                    if (jQuery(this).scrollTop() > 400) {
                        ...
                        jQuery('.header_1 .main-header,.header_2 .main-header,.header_3 .main-header').removeClass("fixed");
                        jQuery(".header_1 .ttresponsive_menu").prependTo(".header_1 .bottom_header_1 .container");
                        jQuery(".header_2 .ttresponsive_menu").prependTo(".header_2 .bottom_header_2 .container");
                    }
                } else {
                    jQuery('.header_1 .main-header,.header_2 .main-header,.header_3 .main-header').removeClass("fixed");
    ...
    var t = {
        ...
        doAjaxAddToCart: function (n, r, a, p, amt, amt1) {
            e.ajax({
                type: "post",
                url: "Product/Index/?handler=AddToCart",
                data: "quantity=" + r + "&price=" + 1200 + "&id=" + n.toString(),
        ...
        doUpdateDropdownCart: function (n) {
            ...
            e("#slidedown-cart .summary .price,.site-header__cart-count .price").html(n.total_price + " rsd.");
            e("#slidedown-cart .mini-products-list").html("");
            e("#Sticky-slidedown-cart .summary .price").html(n.total_price);
            ...
            if (n.item_count > 0) {
                ...
                /*    s = s.replace(/\{VARIANT_TITLE\}/g, n.items[i].variant_title);*/
                    ...
                    s = s.replace(/\{PRICE\}/g, n.items[i].price + " rsd.");
